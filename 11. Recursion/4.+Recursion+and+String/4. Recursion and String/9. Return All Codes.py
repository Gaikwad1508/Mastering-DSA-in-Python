def get_char(value):
    ...
    return chr(97+value-1)          #chr function converts an integer to its corresponding ASCII character, where 'a' is 97 in ASCII.
                                    #ord function converts a character to its corresponding ASCII value, where 'a' is 97 in ASCII. 
